...
/*   Updated: 2025/08/02 18:10:44 by ayusa            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	find_next_word(const char *str, int *start, int *end, char c)
{
	int	i;
...
static int	ft_fill_words(char **tab, const char *str, char c)
{
	int	i;
	int	word;
	int	start;
